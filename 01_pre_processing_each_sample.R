...
sample@meta.data$PIN <- "PIN_1340"
sample@meta.data$Status <- "IBS"
sample@meta.data$Subtype <- "IBS-D"
sample@meta.data$orig.ident <- name
sample@meta.data$Age_group <- "age21_to_30"
sample@meta.data$Pain_score <- "mild"
sample@meta.data$Sex <- "M"
sample@meta.data$Diaorrhea <- "Yes"
